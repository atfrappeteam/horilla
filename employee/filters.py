...
class EmployeeFilter(HorillaFilterSet):
    ...
    selected_search_field = django_filters.ChoiceFilter(
        ...
        choices=[
            ...
            ("designation",_("Search in:Designation")),
    ...
    class Meta:
        ...
        fields = [
            ...
            "department",
            "employee_work_info__designation_id",
...
class EmployeeReGroup:
    ...
    fields = [
        ...
        ("employee_work_info__designation_id", "Designation"),
...
class DocumentRequestFilter(FilterSet):
    ...
    class Meta:
        ...
        fields = [
            ...
            "employee_id__employee_work_info__designation_id",
